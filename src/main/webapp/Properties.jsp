...
<body class="container mt-4">
    ...
    <ul class="nav nav-tabs">
        <li class="nav-item"><a class="nav-link active">Part Properties</a></li>
    ...
    <li class="nav-item"><a class="nav-link" href="ControlManagement.jsp?name=<%= request.getParameter("name") %>">ControlManagement</a></li>
    </ul>
